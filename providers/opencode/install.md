...
Keep `skills/` as the only canonical source tree, then install an OpenCode-friendly layout when needed. The OpenCode adapter notes belong in `providers/opencode/`.
