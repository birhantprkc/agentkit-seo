...
Antigravity should still be authored from the shared `skills/` source tree. Antigravity adapter notes belong in `providers/antigravity/`. The export layer keeps the shared skill bundle canonical first, then packages the Antigravity plugin as an adapter step on top.

That means the installable source content should continue to come from:

- `skills/`
- `providers/antigravity/install.md`
