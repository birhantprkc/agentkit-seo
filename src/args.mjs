...
Usage:
  ...
  vitaecontext mcp [--context <file>] [--root <vitaegraph-dir>]
  ...
  vitaecontext context init [--output <file>] [--force] [--json]
  vitaecontext context validate <file> [--json]
  vitaecontext context summary <file> [--for <cv|github|linkedin|portfolio|x|general>] [--output <file>] [--json]
